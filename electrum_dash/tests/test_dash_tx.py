...
from electrum_dash.dash_tx import (
    SPEC_PRO_REG_TX,
    SPEC_PRO_UP_SERV_TX,
    SPEC_PRO_UP_REG_TX,
    SPEC_PRO_UP_REV_TX,
...
CB_TX_D = {
    'height': 264132,
    'merkleRootMNList': (
        '76629a6e42fb519188f65889fd3ac020'
...
CB_TX_V2_D = {
    'height': 264132,
    'merkleRootMNList': (
        '76629a6e42fb519188f65889fd3ac0201be87aa2'
        '27462b5643e8bb2ec1d7a82a'
    ),
    'merkleRootQuorums': (
        '76629a6e42fb519188f65889fd3ac0201be87aa'
...
CB_TX_V3_D = {
    'height': 900700,
    'merkleRootMNList': (
        '3c7a25cd3258d4141c1aca784232f28b92f94221'
        'c1d6add1c7221ebecffd2012'
    ),
    'merkleRootQuorums': (
        '9752cf4e10c95caefd2972782eb6ab4bc64170c1'
...
PRO_REG_TX_D = {
    ...
    'PubKeyOperator': (
        '00ab986c589053b3f3bd720724e75e18'
        '581afdca54bce80d14750b1bcf920215'
        '8fe6c596ce8391815265747bd4a2009e'
    ),
    'collateralOutpoint': {
        'hash': (
            'dea3f051e4606f1b6547df8c8d6fb856'
            '9273baeed47849c388bc21a3a0afe14d'
        ),
        'index': 1,
    },
    'inputsHash': (
        '54d046585434668b4ee664c597864248'
    ...
    'operatorReward': 0,
    'payloadSig': (
        '1fc1617ae83406c92a9132f14f9fff1487f2890f401e776f'
...
PRO_UP_REV_TX_D = {
    'inputsHash': (
        'eb073521b60306717f1d4feb3e9022f8'
        '86b97bf981137684716a7d3d7e45b7fe'
    ),
    'payloadSig': (
        '83f4bb5530f7c5954e8b1ad50a74a9e1d65dcdcbe4acb8cbe3'
    ...
    'proTxHash': (
        'b67ffbbd095de31ea38446754b6bf251'
...
class TestDashTx(SequentialTestCase):
    ...
    def test_tx_outpoint(self):
        ...
        assert o.hash_is_null is False
...
class TestDashSpecTxSerialization(SequentialTestCase):
    ...
    def test_dash_tx_pro_reg_tx(self):
        ...
        assert extra.collateralOutpoint.hash == bfh(PRO_REG_TX_D['collateralOutpoint']['hash'])[::-1]
        assert extra.collateralOutpoint.index == PRO_REG_TX_D['collateralOutpoint']['index']
        ...
        assert extra2.collateralOutpoint.index == extra.collateralOutpoint.index
    ...
    def test_dash_tx_pro_up_serv_tx(self):
        ...
        assert extra.scriptOperatorPayout == bfh(PRO_UP_SERV_TX_D['scriptOperatorPayout'])
        assert len(extra.inputsHash) == 32
    ...
    def test_dash_tx_pro_up_reg_tx(self):
        ...
        extra2 = ProTxBase.from_hex_str(SPEC_PRO_UP_REG_TX, PRO_UP_REG_TX[384:])
        assert extra2.version == extra.version
        assert extra2.proTxHash == extra.proTxHash
        assert extra2.mode == extra.mode
        assert extra2.PubKeyOperator == extra.PubKeyOperator
    ...
    def test_dash_tx_pro_up_rev_tx(self):
        ...
        extra2 = ProTxBase.from_hex_str(SPEC_PRO_UP_REV_TX, PRO_UP_REV_TX[384:])
        assert extra2.version == extra.version
        assert extra2.proTxHash == extra.proTxHash
    ...
    def test_serialize_command_with_extra_payload(self):
        ...
        res = cmds._run('serialize', (test_json_tx,))
        assert res == {'error': 'Transactions with extra payload can not be created from serialize command'}
